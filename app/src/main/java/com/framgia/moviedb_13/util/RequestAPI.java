...
public class RequestAPI {
    ...
    public List<Genre> parseJsonToGenre(String json) throws JSONException{
        ...
        JSONArray jsonArrayGenres = jsonObject
                .getJSONArray(Constant.ApiResultKey.API_KEY_GENRES);
        for (int i = 0; i < jsonArrayGenres.length(); i++){
            Genre.Builder builder = new Genre.Builder();
            Genre genre = builder.setId(jsonArrayGenres
                                            .getJSONObject(i)
                                            .getString(Constant.ApiResultKey.API_KEY_GENRES_ID))
                                .setName(jsonArrayGenres
                                            .getJSONObject(i)
    ...
    public List<Movie> parseJsonToMovie(String json) throws JSONException{
        ...
        JSONObject jsonObject = new JSONObject(json);
        JSONArray jsonArrayMovies = jsonObject
                .getJSONArray(Constant.ApiResultKey.API_KEY_RESULTS);
    ...
    public List<Production> parseJsonToProductions(String json) throws JSONException{
        ...
        JSONObject jsonObject = new JSONObject(json);
        JSONArray jsonArrayProduction = jsonObject
                .getJSONArray(Constant.ApiResultKey.API_KEY_PRODUCTION_RESULTS);
        for (int i = 0; i < jsonArrayProduction.length(); i++){
            Production.Builder builder = new Production.Builder();
            Production production = builder
                    .setId(jsonArrayProduction.getJSONObject(i)
